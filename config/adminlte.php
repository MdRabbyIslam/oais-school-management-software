...
return [
    ...
    */
    ...
    'logo' => 'Oasis Model School',
    'logo_img' => 'upload/images/Logo__Oysis.png',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Fee Groups',
            'url'  => 'fee-groups',
            'icon' => 'fas fa-cogs', // You can change the icon here
        ],
        [
            'text' => 'Fees',
            'url'  => 'fees',
    ...
    */
    ...
    'plugins' => [
        ...
        'SortableJS' => [
            'active' => false, // set to true to load on every page; or enable per-view
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => 'https://cdn.jsdelivr.net/npm/sortablejs@1.15.2/Sortable.min.js',
                ],
            ],
        ],
    ],
