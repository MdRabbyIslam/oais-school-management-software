...
<head>
    ...
    <title>Class Test Blank Sheet - {{ $classTest->name }}</title>
    <style>
        body {
...
<body>
    ...
    <div class="sheet">
        <div class="title">
            ...
            <h3>Class Test Blank Mark Sheet</h3>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th style="width: 14%;">Obtained Marks</th>
        ...
        <div class="signature" style="margin-top: 100px;">
            <div class="box">Subject Teacher</div>
            <div class="box">Class Teacher</div>
            <div class="box">Exam Controller</div>
        </div>
    </div>
</body>
</html>
