...
@section('title', 'পেমেন্ট রশিদ')

{{-- Print‐only CSS (identical to your English version) --}}
@section('css')
...
@section('content')
  <div class="mb-2 mt-2 no-print">
    ...
    <button onclick="printInvoice()" class="btn btn-info btn-sm ml-3">
   ...
   @if($rowsCount <= 4)
    ...
    <div id="receipt-pairs" class="receipt-pairs">
      <div class="receipt-copy">
        ...
        @include('pages.payments._receipt_content_bn', compact('payment','student'))
      </div>
      <div class="receipt-copy">
        <div class="copy-label">শিক্ষার্থী কপি</div>
        @include('pages.payments._receipt_content_bn', compact('payment','student'))
      </div>
    </div>
  @else
