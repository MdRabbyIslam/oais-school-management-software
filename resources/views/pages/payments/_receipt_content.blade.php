...
<div class="receipt-content">
  ...
  <div class="receipt-header">
    ...
    <div class="school-name">
      <p style="display: none">{{ config('app.school_name_bn', 'ওয়েসিস মডেল স্কুল') }}</p>

      <p style="font-size: 35px;line-height: 100%;margin-bottom: 5px;">{{ config('app.school_name', 'Oasis Model School') }}</p>
    </div>
    {{-- fixed address --}}
  ...
  {{-- FEES SUMMARY --}}
  <table class="items-table" style="margin-top:1.5rem; ">
    <thead>
      <tr>
  ...
  <div style="margin-top:40px; display:flex; justify-content:space-between; page-break-inside:avoid;">
    <div style="text-align:center">
      ...
      <small style="font-size: 10px;">Payer Signature</small>
    </div>
    <div style="text-align:center">
      <div style="border-top:1px solid #000; width:150px; margin:0 auto;"></div>
      <small style="font-size: 10px;">Recipient’s Signature</small>
    </div>
  </div>
